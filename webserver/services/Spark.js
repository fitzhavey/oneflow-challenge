...
/**
 * Class to simplify interaction with the firebase database
 * 
 ...
 *  - further testing required on the validity of the status promises returned
 */
...
class Spark {
     ...
     * @returns a Promise of true is subscription is successful
     */
    subscribeAsArray(path, callback) {
        return Promise.all([
            this.db.ref(path).on('value', snap => {
